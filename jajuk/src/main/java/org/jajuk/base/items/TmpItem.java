...
//
///**
// * Item property handler, parent class for all items
// * <p>
...
// * </p>
// */
//abstract public class TmpItem implements Serializable {
//
//  /**
...
//   *          element name
//   */
//  protected TmpItem(final String sId, final String sName) {
//    sID = sId;
//    setProperty(XML.ID, sId);
//    name = sName;
//    setProperty(XML.NAME, sName);
//  }
//
//  /**
//   * @return
...
//    final PropertyMetaInformation meta = getMeta(sKey);
...
//   */
//  public boolean containsProperty(final String sKey) {
...
//   */
//  public void setProperty(final String sKey, final Object oValue) {
...
//    final LinkedHashMap properties = getProperties();
...
//   *      java.lang.String)
//   */
//  public void populateDefaultProperty(final PropertyMetaInformation meta) {
...
//    final LinkedHashMap<String, Object> properties = getProperties();
//    final StringBuilder sb = new StringBuilder();
//    for (final String sKey : properties.keySet()) {
//      String sValue = null;
...
//   */
//  public PropertyMetaInformation getMeta(final String sProperty) {
//    return ((ItemManager) ItemManager.getItemManager(this.getClass())).getMetaInformation(sProperty);
//  }
//
//  /**
...
//    final Iterator it = propertiesSource.getProperties().keySet().iterator();
//    while (it.hasNext()) {
//      final String sProperty = (String) it.next();
//      if (!getMeta(sProperty).isConstructor()) {
//        properties.put(sProperty, propertiesSource.getValue(sProperty));
//      }
//    }
//  }
//
