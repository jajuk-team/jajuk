...
public class AmbienceManager implements ITechnicalStrings, Observer {
	...
	public void createDefaultAmbiences() {
		...
		String[] stylesHardRock = new String[] { "Grunge", "Metal", "Industrial", "Death Metal",
				...
				"Progressive Rock", "Punk Rock", "Terror", "Negerpunk", "Polsk Punk",
				"Heavy Metal", "Black Metal", "Thrash Metal" };
		AmbienceManager.getInstance().registerAmbience(
				new Ambience("2", Messages.getString("Ambience.2"), stylesHardRock));
		String[] stylesTechno = new String[] { "Dance", "New Age", "Techno", "Euro-Techno",
				"Ambient", "Trance", "House", "Game", "Space", "Techno-Industrial", "Eurodance",
				"Dream", "Jungle", "Rave", "Euro-House", "Goa", "Club-House", "Hardcore", "Beat" };
		AmbienceManager.getInstance().registerAmbience(
		...
		String[] stylesWorld = new String[] { "Ethnic", "Native American", "Tribal", "Polka",
				"Celtic", "Folklore", "Indie" };
		AmbienceManager.getInstance().registerAmbience(
		...
		String[] stylesFolkOldies = new String[] { "Country", "Oldies", "Gospel", "Pop-Folk",
				"Southern Rock", "Cabaret", "Retro", "Folk-Rock", "National Folk", "Swing",
				"Rock & Roll", "Folk", "Revival", "Chanson" };
		AmbienceManager.getInstance().registerAmbience(
		...
		String[] stylesInde = new String[] { "Noise", "AlternRock", "New Wave", "Psychedelic",
				"Acid Punk", "Avantgarde", "Psychedelic Rock", "Freestyle", "Drum Solo",
				"Drum & Bass" };
		AmbienceManager.getInstance().registerAmbience(
