...
public class LoveSelectionAction extends SelectionAction {
  ...
  /**
   * Set love preference to a selection
   * <p>
   * Selection action
   * </p>.
   */
  LoveSelectionAction() {
    super(Messages.getString("Preference.5"), IconLoader.getIcon(JajukIcons.PREFERENCE_LOVE), true);
    setShortDescription(Messages.getString("Preference.5"));
  }
  ...
  public void perform(final ActionEvent e) throws Exception {
    new Thread("LoveSelectionAction") {
      @Override
      public void run() {
        try {
          LoveSelectionAction.super.perform(e);
