...
public class PlaySelectionAction extends SelectionAction {
  ...
  /**
   * Instantiates a new play selection action.
   */
  PlaySelectionAction() {
    super(Messages.getString("TracksTableView.7"), IconLoader.getIcon(JajukIcons.PLAY_16X16), true);
  ...
  public void perform(final ActionEvent e) throws Exception {
    new Thread("PlaySelectionAction") {
      @Override
      public void run() {
        try {
