...
public class PoorSelectionAction extends SelectionAction {
  ...
  /**
   * Set poor preference to a selection
   * <p>
   * Selection action
   * </p>.
   */
  PoorSelectionAction() {
    super(Messages.getString("Preference.2"), IconLoader.getIcon(JajukIcons.PREFERENCE_POOR), true);
    setShortDescription(Messages.getString("Preference.2"));
  }
  ...
  public void perform(final ActionEvent e) throws Exception {
    new Thread("PoorSelectionAction") {
      @Override
      public void run() {
        try {
          PoorSelectionAction.super.perform(e);
