...
public class PushFrontSelectionAction extends SelectionAction {
  ...
  PushFrontSelectionAction() {
    super(Messages.getString("TracksTableView.16"), IconLoader.getIcon(JajukIcons.PUSH), true);
    setShortDescription(Messages.getString("TracksTableView.16"));
  }
  ...
  public void perform(ActionEvent e) throws Exception {
    ...
    FIFO.push(UtilFeatures.createStackItems(UtilFeatures.applyPlayOption(files), Conf
        .getBoolean(Const.CONF_STATE_REPEAT), true), true, true);
  }
