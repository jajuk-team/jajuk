...
public class ParameterView extends ViewAdapter implements ActionListener,
		ListSelectionListener, ItemListener, ChangeListener, Observer {
	...
	public void initUI() {
		...
		jrbLastKeepPos = new JRadioButton(Messages
				.getString("ParameterView.135"));
		...
		jcbBeforeRemoveDevice = new JCheckBox(Messages
				.getString("ParameterView.164"));
		jcbBeforeRemoveDevice.setToolTipText(Messages
				.getString("ParameterView.165"));

		jcbBeforeDeleteCover = new JCheckBox(Messages
				.getString("ParameterView.171"));
		jcbBeforeDeleteCover.setToolTipText(Messages
				.getString("ParameterView.172"));

		jcbBeforeClearingHistory = new JCheckBox(Messages
				.getString("ParameterView.188"));
		jcbBeforeClearingHistory.setToolTipText(Messages
				.getString("ParameterView.188"));

		jcbBeforeResetingRatings = new JCheckBox(Messages
				.getString("ParameterView.189"));
		jcbBeforeResetingRatings.setToolTipText(Messages
				.getString("ParameterView.189"));

		jcbBeforeRefactorFiles = new JCheckBox(Messages
				.getString("ParameterView.194"));
		jcbBeforeRefactorFiles.setToolTipText(Messages
				.getString("ParameterView.194"));
		...
		introPosition.addMouseWheelListener(new DefaultMouseWheelListener(
				introPosition));
		...
		introLength.addMouseWheelListener(new DefaultMouseWheelListener(
				introLength));
		...
		jlVisiblePlanned
				.setToolTipText(Messages.getString("ParameterView.178"));
		jtfVisiblePlanned = new JTextField(3);
		jtfVisiblePlanned.setToolTipText(Messages
				.getString("ParameterView.178"));
		...
		jlCrossFadeDuration = new JLabel(Messages
				.getString("ParameterView.190"));
		jlCrossFadeDuration.setToolTipText(Messages
				.getString("ParameterView.191"));
		...
		crossFadeDuration.setToolTipText(Messages
				.getString("ParameterView.191"));
		crossFadeDuration.addMouseWheelListener(new DefaultMouseWheelListener(
				crossFadeDuration));
		...
		jcbDisplayUnmounted = new JCheckBox(Messages
				.getString("JajukJMenuBar.24"));
		jcbDisplayUnmounted.setToolTipText(Messages
				.getString("ParameterView.35"));

		jcbSyncTableTree = new JCheckBox(Messages
				.getString("ParameterView.183"));
		jcbSyncTableTree
				.setToolTipText(Messages.getString("ParameterView.184"));

		jcbDefaultActionClick = new JCheckBox(Messages
				.getString("ParameterView.179"));
		jcbDefaultActionClick.setToolTipText(Messages
				.getString("ParameterView.180"));

		jcbDefaultActionDrop = new JCheckBox(Messages
				.getString("ParameterView.181"));
		jcbDefaultActionDrop.setToolTipText(Messages
				.getString("ParameterView.182"));
		...
		jlRefactorPattern.setToolTipText(Messages
				.getString("ParameterView.193"));
		jtfRefactorPattern = new JFormattedTextField();
		jtfRefactorPattern.setToolTipText(Messages
				.getString("ParameterView.193"));
		...
		jlAnimationPattern.setToolTipText(Messages
				.getString("ParameterView.193"));
		jtfAnimationPattern = new JTextField();
		jtfAnimationPattern.setToolTipText(Messages
				.getString("ParameterView.193"));
		...
		backupSize.addMouseWheelListener(new DefaultMouseWheelListener(
				backupSize));
		jlCollectionEncoding = new JLabel(Messages
				.getString("ParameterView.120"));
		jlCollectionEncoding.setToolTipText(Messages
				.getString("ParameterView.121"));
		jcbCollectionEncoding = new JComboBox();
		jcbCollectionEncoding.setToolTipText(Messages
				.getString("ParameterView.121"));
		...
		jlJajukWorkspace
				.setToolTipText(Messages.getString("ParameterView.208"));
		// Directory selection
		...
		jcbCheckUpdates.setSelected(ConfigurationManager
				.getBoolean(CONF_CHECK_FOR_UPDATE));
		...
		jtfProxyHostname
				.setToolTipText(Messages.getString("ParameterView.145"));
		...
		connectionTO.addMouseWheelListener(new DefaultMouseWheelListener(
				connectionTO));
		// Add items
		...
		jcbAudioScrobbler = new JCheckBox(Messages
				.getString("ParameterView.199"));
		jcbAudioScrobbler.setToolTipText(Messages
				.getString("ParameterView.200"));
		...
		jcbEnableLastFMInformation = new JCheckBox(Messages
				.getString("ParameterView.240"));
		jcbEnableLastFMInformation.setToolTipText(Messages
				.getString("ParameterView.241"));
		// Add items
		...
		jcbLoadEachTrack = new JCheckBox(Messages
				.getString("ParameterView.175"));
		jcbLoadEachTrack
				.setToolTipText(Messages.getString("ParameterView.176"));
		...
		ToggleLink toggle = new ToggleLink(Messages
				.getString("ParameterView.229"), catalogView);
		...
		jsFonts = new JSlider(8, 16, ConfigurationManager
		...
		jcbVisibleAtStartup
				.setToolTipText(Messages.getString("JajukWindow.25"));
		...
		ActionListener alUI = new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// Store configuration
				ConfigurationManager.setProperty(CONF_UI_SHOW_AT_STARTUP,
						Boolean.toString(jcbVisibleAtStartup.isSelected()));
				...
				ObservationManager.notify(new Event(
						EventSubject.EVENT_PARAMETERS_CHANGE, details));
			}
		...
		jlWatermarkImage
				.setToolTipText(Messages.getString("ParameterView.232"));
		scbWatermarks = new SteppedComboBox();
		Map<String, WatermarkInfo> mapWatermarks = SubstanceLookAndFeel
				.getAllWatermarks();
		...
		JajukFileFilter filter = new JajukFileFilter(
		...
		pathWatermarkFile = new PathSelector(filter, ConfigurationManager
			...
			public void performOnURLChange() {
				ConfigurationManager.setProperty(CONF_OPTIONS_WATERMARK_IMAGE,
		...
		jbOK = new JButton(Messages.getString("ParameterView.85"),
				IconLoader.ICON_OK);
		...
		jtpMain.addTab(Messages.getString("ParameterView.33"),
				new JajukJScrollPane(jpOptions));
		jtpMain.addTab(Messages.getString("ParameterView.226"),
				new JajukJScrollPane(jpModes));
		jtpMain.addTab(Messages.getString("ParameterView.225"),
				new JajukJScrollPane(jpUI));
		jtpMain.addTab(Messages.getString("ParameterView.19"),
				new JajukJScrollPane(jpStart));
		jtpMain.addTab(Messages.getString("ParameterView.98"),
				new JajukJScrollPane(jpTags));
		jtpMain.addTab(Messages.getString("ParameterView.8"),
				new JajukJScrollPane(jpHistory));
		jtpMain.addTab(Messages.getString("ParameterView.235"),
				new JajukJScrollPane(jpLastFM));
		jtpMain.addTab(Messages.getString("ParameterView.159"),
				new JajukJScrollPane(jpCovers));
		jtpMain.addTab(Messages.getString("ParameterView.26"),
				new JajukJScrollPane(jpConfirmations));
		jtpMain.addTab(Messages.getString("ParameterView.139"),
				new JajukJScrollPane(jpNetwork));
		jtpMain.addTab(Messages.getString("ParameterView.115"),
				new JajukJScrollPane(jpAdvanced));
		try {
			// Reload stored selected index
			jtpMain.setSelectedIndex(ConfigurationManager
					.getInt(CONF_OPTIONS_TAB));
		} catch (Exception e) {
		...
		new Thread() {
			public void run() {
				if (e.getSource() == jbClearHistory) {
					...
					ObservationManager.notify(new Event(
							EventSubject.EVENT_CLEAR_HISTORY));
					...
					InformationJPanel.getInstance().setMessage(
							Messages.getString("ParameterView.110"),
					...
					if (jcbBackup.isSelected()) {
						...
						backupSize.setValue(ConfigurationManager
								.getInt(CONF_BACKUP_SIZE));
					} else {
						backupSize.setEnabled(false);
						backupSize.setValue(0);
					}
				} else if (e.getSource() == jcbProxyNone
						|| e.getSource() == jcbProxyHttp
					...
					ConfigurationManager.setProperty(
							CONF_AUDIOSCROBBLER_ENABLE, Boolean
									.toString(jcbAudioScrobbler.isSelected()));
				} else if (e.getSource() == scbLAF) {
					String oldTheme = ConfigurationManager
							.getProperty(CONF_OPTIONS_LNF);
					ConfigurationManager.setProperty(CONF_OPTIONS_LNF,
							(String) scbLAF.getSelectedItem());
					if (!oldTheme.equals(scbLAF.getSelectedItem())) {
						...
						Messages.showHideableWarningMessage(Messages
								.getString("ParameterView.233"),
								CONF_NOT_SHOW_AGAIN_LAF_CHANGE);
					}
				} else if (e.getSource() == scbWatermarks) {
					String oldWatermark = ConfigurationManager
							.getProperty(CONF_OPTIONS_WATERMARK);
					ConfigurationManager.setProperty(CONF_OPTIONS_WATERMARK,
					...
					jlWatermarkImage.setEnabled(watermark
							.equals(LNF_WATERMARK_IMAGE));
					pathWatermarkFile.setEnabled(watermark
							.equals(LNF_WATERMARK_IMAGE));
					...
					String sLocal = Messages
							.getLocalForDesc((String) scbLanguage
									.getSelectedItem());
					String sPreviousLocal = Messages.getInstance().getLocale();
					if (!sPreviousLocal.equals(sLocal)) {
						// local has changed
						ConfigurationManager.setProperty(CONF_OPTIONS_LANGUAGE,
								sLocal);
						Messages.showInfoMessage(Messages
								.getString("ParameterView.198"));
					}
				} else if (e.getSource() == jcbHotkeys) {
					ConfigurationManager.setProperty(CONF_OPTIONS_HOTKEYS,
							Boolean.toString(jcbHotkeys.isSelected()));
	...
	private void applyParameters() {
		...
		ConfigurationManager.setProperty(CONF_OPTIONS_DEFAULT_ACTION_CLICK,
				Boolean.toString(jcbDefaultActionClick.isSelected()));
		ConfigurationManager.setProperty(CONF_OPTIONS_DEFAULT_ACTION_DROP,
		...
		if (jcbAudioScrobbler.isSelected()) {
			ConfigurationManager.setProperty(CONF_AUDIOSCROBBLER_USER,
					jtfASUser.getText());
			ConfigurationManager.setProperty(CONF_AUDIOSCROBBLER_PASSWORD, Util
					.rot13(new String(jpfASPassword.getPassword())));
		}
		int iLogLevel = scbLogLevel.getSelectedIndex();
		Log.setVerbosity(iLogLevel);
		ConfigurationManager.setProperty(CONF_OPTIONS_LOG_LEVEL, Integer
				.toString(iLogLevel));
		ConfigurationManager.setProperty(CONF_OPTIONS_INTRO_BEGIN, Integer
				.toString(introPosition.getValue()));
		ConfigurationManager.setProperty(CONF_OPTIONS_INTRO_LENGTH, Integer
				.toString(introLength.getValue()));
		String sBestofSize = jtfBestofSize.getText();
		if (!sBestofSize.equals("")) {
			ConfigurationManager.setProperty(CONF_BESTOF_TRACKS_SIZE,
					sBestofSize);
		}
		...
		if (!sVisiblePlanned.equals("")) {
			ConfigurationManager.setProperty(CONF_OPTIONS_VISIBLE_PLANNED,
					sVisiblePlanned);
		}
		...
		// server information
		if (Util.isUnderLinux() && oldDuration == 0
				&& oldDuration != crossFadeDuration.getValue()) {
			Messages.showHideableWarningMessage(Messages
					.getString("ParameterView.210"),
					CONF_NOT_SHOW_AGAIN_CROSS_FADE);
		}
		ConfigurationManager.setProperty(CONF_FADE_DURATION, Integer
				.toString(crossFadeDuration.getValue()));
		// Startup
		if (jrbNothing.isSelected()) {
			ConfigurationManager.setProperty(CONF_STARTUP_MODE,
		...
		// Confirmations
		ConfigurationManager.setProperty(CONF_CONFIRMATIONS_DELETE_FILE,
				Boolean.toString(jcbBeforeDelete.isSelected()));
		ConfigurationManager.setProperty(CONF_CONFIRMATIONS_EXIT, Boolean
				.toString(jcbBeforeExit.isSelected()));
		ConfigurationManager.setProperty(CONF_CONFIRMATIONS_REMOVE_DEVICE,
				Boolean.toString(jcbBeforeRemoveDevice.isSelected()));
		ConfigurationManager.setProperty(CONF_CONFIRMATIONS_DELETE_COVER,
				Boolean.toString(jcbBeforeDeleteCover.isSelected()));
		ConfigurationManager.setProperty(CONF_CONFIRMATIONS_CLEAR_HISTORY,
				Boolean.toString(jcbBeforeClearingHistory.isSelected()));
		ConfigurationManager.setProperty(CONF_CONFIRMATIONS_RESET_RATINGS,
		...
		// tags
		ConfigurationManager.setProperty(CONF_TAGS_USE_PARENT_DIR, Boolean
		...
		ConfigurationManager.setProperty(CONF_ANIMATION_PATTERN,
				jtfAnimationPattern.getText());
		// Advanced
		ConfigurationManager.setProperty(CONF_BACKUP_SIZE, Integer
				.toString(backupSize.getValue()));
		ConfigurationManager.setProperty(CONF_COLLECTION_CHARSET,
				jcbCollectionEncoding.getSelectedItem().toString());
		ConfigurationManager.setProperty(CONF_REGEXP, Boolean
				.toString(jcbRegexp.isSelected()));
		ConfigurationManager.setProperty(CONF_CHECK_FOR_UPDATE, Boolean
				.toString(jcbCheckUpdates.isSelected()));
		ConfigurationManager.setProperty(CONF_MPLAYER_ARGS, jtfMPlayerArgs
				.getText());
		ConfigurationManager.setProperty(CONF_ENV_VARIABLES, jtfEnvVariables
				.getText());
		// UI
		ConfigurationManager.setProperty(CONF_CATALOG_PAGE_SIZE, Integer
		...
		ConfigurationManager.setProperty(CONF_FONTS_SIZE, Integer
				.toString(jsFonts.getValue()));
		...
		if (Main.workspace != null
			...
			if (!psJajukWorkspace.getUrl().trim().equals("")) {
				...
				try {
					java.io.File fWorkspace = new java.io.File(psJajukWorkspace
							.getUrl());
					...
					if (!fWorkspace.canRead()) {
						throw new Exception(
								"Cannot write to proposed Workspace");
					}
				} catch (Exception e) {
		...
		// Network
		ConfigurationManager.setProperty(CONF_NETWORK_USE_PROXY, Boolean
				.toString(!jcbProxyNone.isSelected()));
		if (jcbProxyHttp.isSelected()) {
			ConfigurationManager.setProperty(CONF_NETWORK_PROXY_TYPE,
					PROXY_TYPE_HTTP);
		} else if (jcbProxySocks.isSelected()) {
			ConfigurationManager.setProperty(CONF_NETWORK_PROXY_TYPE,
					PROXY_TYPE_SOCKS);
		}
		ConfigurationManager.setProperty(CONF_NETWORK_PROXY_HOSTNAME,
				jtfProxyHostname.getText());
		ConfigurationManager.setProperty(CONF_NETWORK_PROXY_PORT, jtfProxyPort
				.getText());
		ConfigurationManager.setProperty(CONF_NETWORK_PROXY_LOGIN,
				jtfProxyLogin.getText());
		ConfigurationManager.setProperty(CONF_NETWORK_PROXY_PWD, Util
				.rot13(new String(jtfProxyPwd.getPassword())));
		ConfigurationManager.setProperty(CONF_NETWORK_CONNECTION_TO, Integer
				.toString(connectionTO.getValue()));
		// Force global reload of proxy variables
		DownloadManager.setDefaultProxySettings();
		// Covers
		ConfigurationManager.setProperty(CONF_COVERS_AUTO_COVER, Boolean
				.toString(jcbAutoCover.isSelected()));
		ConfigurationManager.setProperty(CONF_COVERS_SHUFFLE, Boolean
				.toString(jcbShuffleCover.isSelected()));
		ConfigurationManager.setProperty(CONF_COVERS_PRELOAD, Boolean
				.toString(jcbPreLoad.isSelected()));
		ConfigurationManager.setProperty(CONF_COVERS_CHANGE_AT_EACH_TRACK,
				Boolean.toString(jcbLoadEachTrack.isSelected()));
		ConfigurationManager.setProperty(CONF_COVERS_SIZE, Integer
		...
		// display a message
		InformationJPanel.getInstance().setMessage(
				Messages.getString("ParameterView.109"),
				InformationJPanel.INFORMATIVE);
	}
	...
	private void updateSelection() {
		...
		jcbBeforeDelete.setSelected(ConfigurationManager
				.getBoolean(CONF_CONFIRMATIONS_DELETE_FILE));
		jcbBeforeExit.setSelected(ConfigurationManager
				.getBoolean(CONF_CONFIRMATIONS_EXIT));
		...
		// options
		boolean bHidden = ConfigurationManager
		...
		jcbHotkeys.setSelected(ConfigurationManager
				.getBoolean(CONF_OPTIONS_HOTKEYS));

		jcbSyncTableTree.setSelected(ConfigurationManager
				.getBoolean(CONF_OPTIONS_SYNC_TABLE_TREE));
		scbLanguage.setSelectedItem(Messages
				.getDescForLocal(ConfigurationManager
		...
		introLength.setValue(ConfigurationManager
				.getInt(CONF_OPTIONS_INTRO_LENGTH));
		introPosition.setValue(ConfigurationManager
				.getInt(CONF_OPTIONS_INTRO_BEGIN));
		...
		jtfNoveltiesAge.setText(ConfigurationManager
				.getProperty(CONF_OPTIONS_NOVELTIES_AGE));
		jtfVisiblePlanned.setText(ConfigurationManager
				.getProperty(CONF_OPTIONS_VISIBLE_PLANNED));
		crossFadeDuration.setValue(ConfigurationManager
				.getInt(CONF_FADE_DURATION));
		jcbUseParentDir.setSelected(ConfigurationManager
				.getBoolean(CONF_TAGS_USE_PARENT_DIR));
		// advanced
		...
		jtfAnimationPattern.setText(ConfigurationManager
				.getProperty(CONF_ANIMATION_PATTERN));
		jtfMPlayerArgs.setText(ConfigurationManager
				.getProperty(CONF_MPLAYER_ARGS));
		jtfEnvVariables.setText(ConfigurationManager
				.getProperty(CONF_ENV_VARIABLES));
		// network
		boolean bUseProxy = ConfigurationManager
				.getBoolean(CONF_NETWORK_USE_PROXY);
		...
		jtfProxyLogin.setText(ConfigurationManager
				.getProperty(CONF_NETWORK_PROXY_LOGIN));
		jtfProxyLogin.setEnabled(bUseProxy);
		jlProxyLogin.setEnabled(bUseProxy);
		...
		jtfProxyPwd.setEnabled(bUseProxy);
		jlProxyPwd.setEnabled(bUseProxy);
		connectionTO.setValue(ConfigurationManager
		...
		jcbAutoCover.setSelected(ConfigurationManager
				.getBoolean(CONF_COVERS_AUTO_COVER));
		jlCoverSize.setEnabled(ConfigurationManager
				.getBoolean(CONF_COVERS_AUTO_COVER));
		jcbCoverSize.setEnabled(ConfigurationManager
				.getBoolean(CONF_COVERS_AUTO_COVER));
		jcbCoverSize.setSelectedIndex(ConfigurationManager
				.getInt(CONF_COVERS_SIZE));
		jcbShuffleCover.setSelected(ConfigurationManager
				.getBoolean(CONF_COVERS_SHUFFLE));
		jcbPreLoad.setSelected(ConfigurationManager
				.getBoolean(CONF_COVERS_PRELOAD));
		jcbPreLoad.setEnabled(ConfigurationManager
				.getBoolean(CONF_COVERS_AUTO_COVER));
		...
		jcbVisibleAtStartup.setSelected(ConfigurationManager
				.getBoolean(CONF_UI_SHOW_AT_STARTUP));
		jcbShowBaloon.setSelected(ConfigurationManager
				.getBoolean(CONF_UI_SHOW_BALLOON));
	...
	public void valueChanged(ListSelectionEvent e) {
		if (!e.getValueIsAdjusting()) {
			...
			ConfigurationManager.setProperty(CONF_STARTUP_FILE, sr.getFile()
					.getId());
			sbSearch.popup.hide();
		}
	}
	...
	public void stateChanged(ChangeEvent e) {
		...
		ConfigurationManager.setProperty(CONF_OPTIONS_TAB, Integer
				.toString(jtpMain.getSelectedIndex()));
	}
	...
	public void update(Event event) {
		...
		if (EventSubject.EVENT_PARAMETERS_CHANGE.equals(subject)) {
			...
			if (event.getDetails() != null
					&& event.getDetails().get(DETAIL_ORIGIN) != null
