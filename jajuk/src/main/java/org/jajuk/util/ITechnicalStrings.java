...
public interface ITechnicalStrings {
  ...
  public static final String FILE_BOOTSTRAP = System.getProperty("user.home") + "/.jajuk_bootstrap";
  ...
  public static final URL FILE_REPORTING_CSS_ALL_PATH = Util.getResource("xslt/"
      + FILE_REPORTING_CSS_ALL_FILENAME);

  public static final String FILE_REPORTING_CSS_PRINT_FILENAME = "report-print.css";

  public static final URL FILE_REPORTING_CSS_PRINT_PATH = Util.getResource("xslt/"
  ...
  public static final URL XSLT_COLLECTION_LOGICAL = Util.getResource("xslt/logical_collection.xsl");
  ...
  public static final String[] XML_RESERVED_ATTRIBUTE_NAMES = { XML_NAME, XML_ID,
      ...
      XML_ALBUM, XML_AUTHOR, XML_STYLE, XML_TRACK_LENGTH, XML_YEAR, XML_TRACK_RATE, XML_FILES,
      XML_TRACK_HITS, XML_TRACK_ADDED, XML_DIRECTORY_PARENT, XML_DEVICE, XML_DIRECTORY, XML_TRACK,
      XML_SIZE, XML_QUALITY, XML_HASHCODE, XML_PLAYLIST_FILES, XML_TRACK_COMMENT, XML_ANY,
      XML_TRACK_ORDER, XML_DEVICE_SYNCHRO_MODE, XML_DEVICE_SYNCHRO_SOURCE, XML_FILE_DATE }; // contains
