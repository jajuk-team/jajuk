...
public class IconLoader implements ITechnicalStrings {
  ...
  public static final UrlImageIcon ICON_NEW = new UrlImageIcon(Util
  ...
  public static final UrlImageIcon ICON_DEVICE_NETWORK_DRIVE_UNMOUNTED_SMALL = new UrlImageIcon(
  ...
  public static final UrlImageIcon ICON_OK = new UrlImageIcon(Util
  ...
  public static final UrlImageIcon ICON_KO = new UrlImageIcon(Util
  ...
  public static final UrlImageIcon ICON_ADD = new UrlImageIcon(Util
  ...
  public static final UrlImageIcon ICON_UP = new UrlImageIcon(Util
  ...
  public static final UrlImageIcon ICON_TIP = new UrlImageIcon(Util
