...
public class JajukFileFilter extends FileFilter implements java.io.FileFilter, ITechnicalStrings {
  ...
  public boolean accept(final File f) {
	...
	/**
	 * Returns an array of strings containing the extension patterns defined
	 * by the current JajukFileFilter object instance.
	 *
	 * @return
	 ...
	 * filter's registered extension.
	 * Beware that this method may be overriden.
	 *
	 * @param  file
	 *               the file to be filtered
	 * @return
	 *               known-extension flag
	 */
	 ...
	 *               the file to be filtered
	 * @return
	 *               display status flag (fallback is false)
	 */
