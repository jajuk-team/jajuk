...
<!-- 
	Description: This XSLT transforms a xml file containing the tagging of a full collection
				 and it's children devices, directories, and files into an html file.
	Author: Ronak Patel
...
<xsl:template match="collection">
	...
	<tr>
		<td class="device">Device Type</td>
		<td><xsl:value-of select="type" /> </td>
	</tr>
	<tr>
		<td class="device">Device Url</td>
		<td><xsl:value-of select="url" /> </td>
	</tr>
	<tr>
		<td class="device">Device Mount Point</td>
