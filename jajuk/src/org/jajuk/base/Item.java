...
abstract public class Item implements Serializable, ITechnicalStrings {
    ...
    /**
         * Return String value for String type values. We assume that given
         * property is a String. If you are not sure, use Util.parse method
         */
    ...
    /*
         * (non-Javadoc)
         * 
         * @see org.jajuk.base.Item#setProperty(java.lang.String,
         *      java.lang.String)
         */
    ...
    /**
         * @return an identifier used to generate XML representation of this
         *         item
         */
