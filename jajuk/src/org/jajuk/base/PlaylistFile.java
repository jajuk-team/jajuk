...
public class PlaylistFile extends Item implements Comparable {
    ...
    /**
         * Alphabetical comparator used to display ordered lists of playlist
         * files
         * <p>
         * Sort ignoring cases but different items with different cases should
         * be distinct before being added into bidimap
         * </p>
         * 
         * @param other
    ...
    /**
         * Force playlist re-read (don't use the cache). Can be used after a
         * forced refresh
         * 
         */
    ...
    /**
         * 
         * @return whether this playlist contains files located out of known
         *         devices
         */
