...
public class HTMLExporter extends Exporter implements ITechnicalStrings {
	...
	/**
	 * This methods will create an html String of an album and the tracks associated with it.
	 * @param album The album to start from.
	 * @return Returns a string containing the html markup, or null if an error occurred.
	 */
	...
	/**
	 * This method will create an html String of an author and the albums and tracks 
	 * associated with it.
	 * @param author The author to start from..
	 * @return Returns a string containing the html markup, or null if an error occurred.
	 */
	...
	/**
	 * This methods will create an html String of a directory and all its children
	...
	/**
	 * This methods will create an html String of a collection and all its children
	 * devices, directories, and files.
	 * @param COLLECTION_TYPE The type of collection to export.
	...
	public String processCollection(int COLLECTION_TYPE, ArrayList collection) {
		...
		// Else if we are exporting the logical genre collection...
			...
			XMLExporter xmlExporter = XMLExporter.getInstance();
			// Create an xml tagging of the collection.
			String xml = xmlExporter.processCollection(XMLExporter.LOGICAL_GENRE_COLLECTION, collection);
		...
		// Else if we are exporting the logical artist collection...
			...
			XMLExporter xmlExporter = XMLExporter.getInstance();
			// Create an xml tagging of the collection.
			String xml = xmlExporter.processCollection(XMLExporter.LOGICAL_ARTIST_COLLECTION, collection);
		...
		// Else if we are exporting the logical album collection...
			...
			XMLExporter xmlExporter = XMLExporter.getInstance();
			// Create an xml tagging of the collection.
			String xml = xmlExporter.processCollection(XMLExporter.LOGICAL_ALBUM_COLLECTION, collection);
