...
public class HTMLExporter extends Exporter implements ITechnicalStrings {
    ...
    /**
         ...
         * @return Returns a string containing the html markup, or null if an
         *         error occurred.
         */
    ...
    /**
         * This method will create an html String of an author and the albums
         * and tracks associated with it.
         * 
         * @param author
    ...
    /**
         * This methods will create an html String of a device and all its
         * children files and directories.
         * 
         * @param device
