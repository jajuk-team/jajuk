...
public class XMLExporter extends Exporter implements ITechnicalStrings {
    ...
    /**
         * This method will create a tagging of the specified album and its
         * tracks.
         * 
         * @param album
         *                The album to tag.
    ...
    /**
         * This method will create a tagging of the specified author and its
         * albums and associated tracks.
         * 
         * @param author
         *                The author to tag.
         * @return Returns a string containing the tagging, or null if an error
	...
	if (directory != null) {
	    ...
	    ListIterator itr1 = new ArrayList(directory.getDirectories())
		    .listIterator();
	    while (itr1.hasNext()) {
	...
	if (device != null) {
	    ...
	    ListIterator itr = new ArrayList(DirectoryManager.getInstance()
    ...
    /**
         * This method will take a constant specifying what type of collection
         * to export.
         * 
         * @param COLLECTION_TYPE
         *                This XMLExporter constant specifies what type of
         *                collection we're exporting.
         * @param collection
         *                An ArrayList of the collection to export. Should be
         *                null if exporting the physical collection. Just
         *                specify the COLLECTION_TYPE.
         * @return Returns a string containing the tagging of the collection,
         *         null if no tagging was created.
         */
	...
	if (COLLECTION_TYPE == XMLExporter.PHYSICAL_COLLECTION) {
	    ...
	    Iterator<Device> itr0 = DeviceManager.getInstance().getDevices()
		    .iterator();
	    // Tag each device.
	    while (itr0.hasNext()) {
		...
		ListIterator itr1 = new ArrayList(DirectoryManager
	...
	if (album.getTracks() != null && !album.getTracks().isEmpty()) {
	    sGenreName = Util.formatXML(album.getTracks().get(0).getStyle()
		    .getName2());
	    sAuthorName = Util.formatXML(album.getTracks().get(0).getAuthor()
		    .getName2());
	}
