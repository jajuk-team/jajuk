...
public class AmbienceManager implements ITechnicalStrings, Observer {
    ...
    private HashMap<String, Ambience> ambiences = new HashMap<String, Ambience>(
	    10);
	...
	while (e.hasMoreElements()) {
		...
		Ambience ambience = new Ambience(ambienceID, ambienceName,
			styles);
	...
	String sDefault = ConfigurationManager
		.getProperty(CONF_DEFAULT_AMBIENCE);
	...
	ObservationManager.notify(new Event(
		EventSubject.EVENT_AMBIENCE_REMOVED, properties));
    }
	...
	String[] stylesRockPop = new String[] {
		"Classic Rock", "Pop", "Rock", "Ska", "AlternRock", "Instrumental Pop", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$
	...
	AmbienceManager.getInstance().registerAmbience(
		new Ambience(
			"0", Messages.getString("Ambience.0"), stylesRockPop)); //$NON-NLS-1$ //$NON-NLS-2$
	String[] stylesRap = new String[] {
		"Hip-Hop", "R&B", "Rap", "Fusion", "Gangsta", "Christian Rap", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$
	...
	AmbienceManager.getInstance().registerAmbience(
		new Ambience(
			"2", Messages.getString("Ambience.2"), stylesHardRock)); //$NON-NLS-1$ //$NON-NLS-2$
	...
	AmbienceManager.getInstance().registerAmbience(
		new Ambience(
			"3", Messages.getString("Ambience.3"), stylesTechno)); //$NON-NLS-1$ //$NON-NLS-2$
	String[] stylesElectro = new String[] {
		"Trip-Hop", "Acid", "Electronic", "Club" }; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
	AmbienceManager.getInstance().registerAmbience(
		new Ambience(
			"4", Messages.getString("Ambience.4"), stylesElectro)); //$NON-NLS-1$ //$NON-NLS-2$
	...
	AmbienceManager
		...
		.registerAmbience(
			new Ambience(
				"5", Messages.getString("Ambience.5"), stylesClassical)); //$NON-NLS-1$ //$NON-NLS-2$
	...
	AmbienceManager
		...
		.registerAmbience(
			new Ambience(
				"6", Messages.getString("Ambience.6"), stylesSoft)); //$NON-NLS-1$ //$NON-NLS-2$
	String[] stylesParty = new String[] {
		"Dance", "Disco", "Funk", "Ska", "Soul", "Eurodance", "Big Band", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$
		"Club", "Rhytmic Soul", "Dance Hall", "Club-House" }; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
	AmbienceManager
		.getInstance()
		.registerAmbience(
			new Ambience(
				"7", Messages.getString("Ambience.7"), stylesParty)); //$NON-NLS-1$ //$NON-NLS-2$
	String[] stylesJazzBlues = new String[] {
		"Jazz", "Jazz+Funk", "Bass", "Acid Jazz" }; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
	AmbienceManager
		.getInstance()
		.registerAmbience(
			new Ambience(
				"8", Messages.getString("Ambience.8"), stylesJazzBlues)); //$NON-NLS-1$ //$NON-NLS-2$
	String[] stylesWorld = new String[] {
		"Ethnic", "Native American", "Tribal", "Polka", "Celtic", "Folklore", "Indie" }; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$
	AmbienceManager
		.getInstance()
		.registerAmbience(
			new Ambience(
				"9", Messages.getString("Ambience.9"), stylesWorld)); //$NON-NLS-1$ //$NON-NLS-2$
	String[] stylesOthers = new String[] {
		"Other", "Alternative", "Soundtrack", "Vocal", "Meditative", "Comedy", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$
		"Humour", "Speech", "Anime" }; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	AmbienceManager.getInstance().registerAmbience(
		new Ambience(
			"10", Messages.getString("Ambience.10"), stylesOthers)); //$NON-NLS-1$ //$NON-NLS-2$
	String[] stylesFolkOldies = new String[] {
		"Country", "Oldies", "Gospel", "Pop-Folk", "Southern Rock", "Cabaret" //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$
		,
	...
	AmbienceManager
		...
		.registerAmbience(
			new Ambience(
				"11", Messages.getString("Ambience.11"), stylesFolkOldies)); //$NON-NLS-1$ //$NON-NLS-2$
	String[] stylesInde = new String[] {
		"Noise", "AlternRock", "New Wave", "Psychedelic", "Acid Punk", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$
		"Avantgarde", "Psychedelic Rock", "Freestyle", "Drum Solo", "Drum & Bass" }; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$
	AmbienceManager.getInstance().registerAmbience(
		new Ambience(
			"12", Messages.getString("Ambience.12"), stylesInde)); //$NON-NLS-1$ //$NON-NLS-2$
	String[] stylesLatin = new String[] {
		"Latin", "Tango", "Samba", "Acapella", "Salsa" }; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$
	AmbienceManager.getInstance().registerAmbience(
		new Ambience(
			"13", Messages.getString("Ambience.13"), stylesLatin)); //$NON-NLS-1$ //$NON-NLS-2$
    }
