...
public class Messages extends DefaultHandler implements ITechnicalStrings {
    ...
    /**
         * Messages themself extracted from an XML file to this properties
         * class*
         */
    ...
    /**
         ...
         * </pre>
         * 
         * Using <tt>Messages.getAll("example");</tt> will return a size 3
         * String array containing the messages in order. <P/> The keys need to
         * have continuous numbers. So, adding <tt>example.5=Message 5</tt> to
         * the bundle, will not result in adding it to the array without first
         * adding <tt>example.3</tt> and <tt>example.4</tt>.
         * 
         * @param base
         *                The base to use for generating the keys.
         * @return An array of Strings containing the messages linked to the
         *         key, never <tt>null</tt>. If <tt>base.0</tt> is not
         *         found, and empty array is returned.
         */
    ...
    /**
         * Return the message display to the user corresponding to the error
         * code.
         * 
         * @param pCode
         *                Error code.
    ...
    /**
         * Show a dialog with specified warning message + a "not show again"
         * button
         * 
         * @param sMessage
         * @param sProperty :
    ...
    /**
         * Return true if the messaging system is started, can be usefull mainly
         * at startup by services ( like logs) using them to avoid dead locks
         * 
         * @return
         */
