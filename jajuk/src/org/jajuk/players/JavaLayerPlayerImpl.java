...
public class JavaLayerPlayerImpl implements IPlayerImpl, ITechnicalStrings,
    ...
    /*
         * (non-Javadoc)
         * 
         * @see org.jajuk.players.IPlayerImpl#play(org.jajuk.base.File, float,
         *      long, float)
         */
    ...
    /*
         * (non-Javadoc)
         * 
         * @see org.jajuk.players.IPlayerImpl#seek(float) Ogg vorbis seek not
         *      yet supported
         */
	...
	if ((System.currentTimeMillis() - lDateLastUpdate) > PROGRESS_STEP) {
		...
		if (Util.needFullFC()) {
		    ...
		    /*
                         * we have to launch the next file from another thread
                         * to avoid stopping current track (perceptible during
