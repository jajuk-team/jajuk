...
public class JPressButton extends JajukButton {
    ...
    /**
         ...
         * @see #readObject
         */
    private static final String uiClassID = "ButtonUI"; //$NON-NLS-1$

    /**
         * Creates a button with no set text or icon and a default action
         * interval.
         */
    public JPressButton() {
    ...
    /**
         ...
         *                the interval between 2 successive actionperformed
         *                calls.
         */
    ...
    /**
         ...
         * <code>Action</code> supplied. The default action interval is used.
         * 
         * @param a
    ...
    /**
         * @return the used interval between two successive calls to
         *         actionPerformed.
         */
    ...
    /**
         * @param actionInterval
         *                sets the interval between two successive calls to
         *                actionPerformed.
         */
    ...
    /**
         * Button model for the <code>PressButton</code>. The model launches
         * a thread when the button remains pressed. The ends whenever the
         * button releases.
         * 
         * @see ActionThread
         */
