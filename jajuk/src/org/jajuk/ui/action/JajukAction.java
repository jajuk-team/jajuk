...
public enum JajukAction {
    ...
    /**
         * Used as heart beat for general use to refresh subscribers every n
         * secs.
         */
    HEART_BEAT,
    ...
    /**
         * Used when a special mode (global shuffle, novelties, bestof...)
         * changed.
         */
    SPECIAL_MODE,
    ...
    /**
         * Used when the finish album button is pressed. Indicates the current
         * album will play until the end.
         */
    FINISH_ALBUM,
