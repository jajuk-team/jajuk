...
public class WikipediaView extends ViewAdapter implements ITechnicalStrings,
    ...
    /**
         * Overwride paint method to fix an issue with WebBrowser: when user
         * select another perspective and come back, it is void We have to force
         * setUrl to repaint it
         */
