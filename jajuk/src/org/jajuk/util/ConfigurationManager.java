...
public class ConfigurationManager implements ITechnicalStrings {
    ...
    /**
         * Return the value of a property as a boolean or false if the property
         * is not found
         * 
         * @param pName
         *                Name of the property.
    ...
    /**
         * Return the value of a property as a float or 0f if the property is
         * not found
         * 
         * @param pName
         *                Name of the property.
    ...
    /**
         * Return the value of a property as an integer or 0 if the property is
         * not found
         * 
         * @param pName
         *                Name of the property.
    ...
    /**
         * Set default language without properties file available (normaly only
         * at install)
         * 
         */
