...
public enum EventSubject {
	...
	EVENT_VIEW_REFRESH_REQUEST, // refresh a view is required, used in the
	// device view
	EVENT_VIEW_CLOSE_REQUEST, // close a view
	EVENT_VIEW_SHOW_REQUEST, // show a view
	EVENT_VIEW_SHOW_STATUS_CHANGED_REQUEST, // change
	EVENT_VIEW_RESTORE_DEFAULTS, EVENT_VIEW_COMMAND_SELECT_HISTORY_ITEM, EVENT_HELP_REQUIRED, // The
	// help
	// should
	// be
	// displayed
	...
	EVENT_PLAYLIST_REFRESH, EVENT_PLAYLIST_SELECTION_CHANGED, EVENT_FILE_LAUNCHED, // a
	// file
	// has
	// been
	// lauched
	...
	// the
	// fifo
	EVENT_HEART_BEAT, // heart beat for geenral use to refresh subscribers
	// every n secs
	EVENT_ZERO, // a reinit has been required
	EVENT_ADD_HISTORY_ITEM, // a new element has been added in the history
	EVENT_SPECIAL_MODE, // special mode (global shuffle, novelties, bestof...)
	// changed
