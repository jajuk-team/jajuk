...
public interface ITechnicalStrings {
    ...
    // icons
    public static final URL ICON_LOGO = ClassLoader.getSystemResource("org/jajuk/icons/64x64/jajuk-icon_64x64.png");
    public static final URL ICON_TRAY = ClassLoader.getSystemResource("org/jajuk/icons/22x22/jajuk-icon_22x22.png");
    public static final URL ICON_LOGO_FRAME = ClassLoader.getSystemResource("org/jajuk/icons/16x16/jajuk-icon_16x16.png");
    public static final URL ICON_REPEAT = ClassLoader.getSystemResource("org/jajuk/icons/16x16/repeat.png");
    public static final URL ICON_SHUFFLE = ClassLoader.getSystemResource("org/jajuk/icons/16x16/shuffle.png"); 
    public static final URL ICON_CONTINUE = ClassLoader.getSystemResource("org/jajuk/icons/16x16/continue.png");
    public static final URL ICON_INTRO = ClassLoader.getSystemResource("org/jajuk/icons/16x16/intro.png");
    public static final URL ICON_SHUFFLE_GLOBAL = ClassLoader.getSystemResource("org/jajuk/icons/16x16/shuffle_global.png");
    public static final URL ICON_BESTOF = ClassLoader.getSystemResource("org/jajuk/icons/16x16/bestof.png");
    public static final URL ICON_MUTE = ClassLoader.getSystemResource("org/jajuk/icons/16x16/mute.png");
    public static final URL ICON_UNMUTE = ClassLoader.getSystemResource("org/jajuk/icons/16x16/unmute.png");
    public static final URL ICON_NOVELTIES =  ClassLoader.getSystemResource("org/jajuk/icons/16x16/novelties.png");
    public static final URL ICON_PREVIOUS = ClassLoader.getSystemResource("org/jajuk/icons/16x16/previous.png");
    public static final URL ICON_NEXT = ClassLoader.getSystemResource("org/jajuk/icons/16x16/next.png");
    public static final URL ICON_REW = ClassLoader.getSystemResource("org/jajuk/icons/16x16/player_rew.png");
    public static final URL ICON_PLAY = ClassLoader.getSystemResource("org/jajuk/icons/16x16/player_play.png");
    public static final URL ICON_PAUSE = ClassLoader.getSystemResource("org/jajuk/icons/16x16/player_pause.png");
    public static final URL ICON_STOP = ClassLoader.getSystemResource("org/jajuk/icons/16x16/player_stop.png");
    public static final URL ICON_FWD = ClassLoader.getSystemResource("org/jajuk/icons/16x16/player_fwd.png");
    public static final URL ICON_VOLUME = ClassLoader.getSystemResource("org/jajuk/icons/16x16/volume.png");
    public static final URL ICON_POSITION = ClassLoader.getSystemResource("org/jajuk/icons/16x16/position.png");
    public static final URL ICON_INFO   = ClassLoader.getSystemResource("org/jajuk/icons/16x16/info.png");
    public static final URL ICON_PERSPECTIVE_PHYSICAL = ClassLoader.getSystemResource("org/jajuk/icons/16x16/physical_perspective.png"); 
    public static final URL ICON_PERSPECTIVE_LOGICAL    = ClassLoader.getSystemResource("org/jajuk/icons/16x16/logical_perspective.png");
    public static final URL ICON_PERSPECTIVE_STATISTICS = ClassLoader.getSystemResource("org/jajuk/icons/16x16/statistics_perspective.png");
    public static final URL ICON_PERSPECTIVE_CONFIGURATION  = ClassLoader.getSystemResource("org/jajuk/icons/16x16/configure.png");
    public static final URL ICON_PERSPECTIVE_PLAYER = ClassLoader.getSystemResource("org/jajuk/icons/16x16/player_perspective.png");
    public static final URL ICON_PERSPECTIVE_CATALOG = ClassLoader.getSystemResource("org/jajuk/icons/16x16/thumbnail.png");
    public static final URL ICON_PERSPECTIVE_INFORMATION = ClassLoader.getSystemResource("org/jajuk/icons/16x16/contents.png");
    public static final URL ICON_PERSPECTIVE_HELP   = ClassLoader.getSystemResource("org/jajuk/icons/16x16/info.png");
    public static final URL ICON_OPEN_FILE  = ClassLoader.getSystemResource("org/jajuk/icons/16x16/fileopen.png");
    public static final URL ICON_EXIT=  ClassLoader.getSystemResource("org/jajuk/icons/16x16/exit.png");
    public static final URL ICON_NEW=  ClassLoader.getSystemResource("org/jajuk/icons/16x16/new.png");
    public static final URL ICON_DELETE=  ClassLoader.getSystemResource("org/jajuk/icons/16x16/delete.png");
    public static final URL ICON_PROPERTIES=  ClassLoader.getSystemResource("org/jajuk/icons/16x16/fileopen.png");
    public static final URL ICON_VOID=  ClassLoader.getSystemResource("org/jajuk/icons/16x16/void.png");
    public static final URL ICON_CONFIGURATION   = ClassLoader.getSystemResource("org/jajuk/icons/16x16/configure.png");
    public static final URL ICON_MOUNT=  ClassLoader.getSystemResource("org/jajuk/icons/16x16/mount.png");
    public static final URL ICON_UNMOUNT=  ClassLoader.getSystemResource("org/jajuk/icons/16x16/unmount.png");
    public static final URL ICON_TRACES=  ClassLoader.getSystemResource("org/jajuk/icons/16x16/properties.png");
    public static final URL ICON_TEST=  ClassLoader.getSystemResource("org/jajuk/icons/16x16/test.png");
    public static final URL ICON_REFRESH=  ClassLoader.getSystemResource("org/jajuk/icons/16x16/refresh.png");
    public static final URL ICON_SYNCHRO=  ClassLoader.getSystemResource("org/jajuk/icons/16x16/synchro.png");
    public static final URL ICON_DEVICE_NEW=  ClassLoader.getSystemResource("org/jajuk/icons/64x64/new.png");
    public static final URL ICON_DEVICE_CD_MOUNTED =  ClassLoader.getSystemResource("org/jajuk/icons/64x64/cdrom_mount.png");
    public static final URL ICON_DEVICE_CD_UNMOUNTED =  ClassLoader.getSystemResource("org/jajuk/icons/64x64/cdrom_unmount.png");
    public static final URL ICON_DEVICE_CD_AUDIO_MOUNTED =  ClassLoader.getSystemResource("org/jajuk/icons/64x64/cdaudio_mount.png");
    public static final URL ICON_DEVICE_CD_AUDIO_UNMOUNTED =  ClassLoader.getSystemResource("org/jajuk/icons/64x64/cdaudio_unmount.png");
    public static final URL ICON_DEVICE_EXT_DD_MOUNTED =  ClassLoader.getSystemResource("org/jajuk/icons/64x64/ext_dd_mount.png");
    public static final URL ICON_DEVICE_EXT_DD_UNMOUNTED =  ClassLoader.getSystemResource("org/jajuk/icons/64x64/ext_dd_unmount.png");
    public static final URL ICON_DEVICE_DIRECTORY_MOUNTED =  ClassLoader.getSystemResource("org/jajuk/icons/64x64/folder_mount.png");
    public static final URL ICON_DEVICE_DIRECTORY_UNMOUNTED =  ClassLoader.getSystemResource("org/jajuk/icons/64x64/folder_unmount.png");
    public static final URL ICON_DEVICE_PLAYER_MOUNTED =  ClassLoader.getSystemResource("org/jajuk/icons/64x64/player_mount.png");
    public static final URL ICON_DEVICE_PLAYER_UNMOUNTED =  ClassLoader.getSystemResource("org/jajuk/icons/64x64/player_unmount.png");
    public static final URL ICON_DEVICE_REMOTE_MOUNTED =  ClassLoader.getSystemResource("org/jajuk/icons/64x64/remote_mount.png");
    public static final URL ICON_DEVICE_REMOTE_UNMOUNTED =  ClassLoader.getSystemResource("org/jajuk/icons/64x64/remote_unmount.png");
    public static final URL ICON_DEVICE_NETWORK_DRIVE_MOUNTED =  ClassLoader.getSystemResource("org/jajuk/icons/64x64/nfs_mount.png");
    public static final URL ICON_DEVICE_NETWORK_DRIVE_UNMOUNTED =  ClassLoader.getSystemResource("org/jajuk/icons/64x64/nfs_unmount.png");
    public static final URL ICON_DEVICE_CD_MOUNTED_SMALL =  ClassLoader.getSystemResource("org/jajuk/icons/22x22/cdrom_mount.png");
    public static final URL ICON_DEVICE_CD_UNMOUNTED_SMALL =  ClassLoader.getSystemResource("org/jajuk/icons/22x22/cdrom_unmount.png");
    public static final URL ICON_DEVICE_CD_AUDIO_MOUNTED_SMALL =  ClassLoader.getSystemResource("org/jajuk/icons/22x22/cdaudio_mount.png");
    public static final URL ICON_DEVICE_CD_AUDIO_UNMOUNTED_SMALL =  ClassLoader.getSystemResource("org/jajuk/icons/22x22/cdaudio_unmount.png");
    public static final URL ICON_DEVICE_EXT_DD_MOUNTED_SMALL =  ClassLoader.getSystemResource("org/jajuk/icons/22x22/ext_dd_mount.png");
    public static final URL ICON_DEVICE_EXT_DD_UNMOUNTED_SMALL =  ClassLoader.getSystemResource("org/jajuk/icons/22x22/ext_dd_unmount.png");
    public static final URL ICON_DEVICE_NETWORK_DRIVE_MOUNTED_SMALL =  ClassLoader.getSystemResource("org/jajuk/icons/22x22/nfs_mount.png");
    public static final URL ICON_DEVICE_NETWORK_DRIVE_UNMOUNTED_SMALL =  ClassLoader.getSystemResource("org/jajuk/icons/22x22/nfs_unmount.png");
    public static final URL ICON_DEVICE_DIRECTORY_MOUNTED_SMALL =  ClassLoader.getSystemResource("org/jajuk/icons/22x22/folder_mount.png");
    public static final URL ICON_DEVICE_DIRECTORY_UNMOUNTED_SMALL =  ClassLoader.getSystemResource("org/jajuk/icons/22x22/folder_unmount.png");
    public static final URL ICON_DEVICE_PLAYER_MOUNTED_SMALL =  ClassLoader.getSystemResource("org/jajuk/icons/22x22/player_mount.png");
    public static final URL ICON_DEVICE_PLAYER_UNMOUNTED_SMALL =  ClassLoader.getSystemResource("org/jajuk/icons/22x22/player_unmount.png");
    public static final URL ICON_DEVICE_REMOTE_MOUNTED_SMALL =  ClassLoader.getSystemResource("org/jajuk/icons/22x22/remote_mount.png");
    public static final URL ICON_DEVICE_REMOTE_UNMOUNTED_SMALL =  ClassLoader.getSystemResource("org/jajuk/icons/22x22/remote_unmount.png");
    public static final URL ICON_OK =  ClassLoader.getSystemResource("org/jajuk/icons/22x22/ok.png");
    public static final URL ICON_OK_SMALL =  ClassLoader.getSystemResource("org/jajuk/icons/16x16/ok.png");
    public static final URL ICON_KO =  ClassLoader.getSystemResource("org/jajuk/icons/22x22/ko.png");
    public static final URL ICON_FILE =  ClassLoader.getSystemResource("org/jajuk/icons/16x16/track.png");
    public static final URL ICON_DIRECTORY_SYNCHRO =  ClassLoader.getSystemResource("org/jajuk/icons/16x16/dir_synchro.png");
    public static final URL ICON_DIRECTORY_DESYNCHRO =  ClassLoader.getSystemResource("org/jajuk/icons/16x16/dir_desynchro.png");
    public static final URL ICON_PLAYLIST_FILE =  ClassLoader.getSystemResource("org/jajuk/icons/16x16/playlist.png");
    public static final URL ICON_STYLE =  ClassLoader.getSystemResource("org/jajuk/icons/16x16/style.png");
    public static final URL ICON_AUTHOR =  ClassLoader.getSystemResource("org/jajuk/icons/16x16/author.png");
    public static final URL ICON_ALBUM =  ClassLoader.getSystemResource("org/jajuk/icons/16x16/album.png");
    public static final URL ICON_APPLY_FILTER =  ClassLoader.getSystemResource("org/jajuk/icons/16x16/filter.png");
    public static final URL ICON_CLEAR_FILTER =  ClassLoader.getSystemResource("org/jajuk/icons/16x16/clear.png");
    public static final URL ICON_ADVANCED_FILTER =  ClassLoader.getSystemResource("org/jajuk/icons/16x16/complex_search.png");
    public static final URL ICON_PLAYLIST_QUEUE =  ClassLoader.getSystemResource("org/jajuk/icons/40x40/playlist_queue.png");
    public static final URL ICON_PLAYLIST_NORMAL =  ClassLoader.getSystemResource("org/jajuk/icons/40x40/playlist_normal.png");
    public static final URL ICON_PLAYLIST_NEW =  ClassLoader.getSystemResource("org/jajuk/icons/40x40/playlist_new.png");
    public static final URL ICON_PLAYLIST_BOOKMARK =  ClassLoader.getSystemResource("org/jajuk/icons/40x40/playlist_bookmark.png");
    public static final URL ICON_PLAYLIST_BESTOF =  ClassLoader.getSystemResource("org/jajuk/icons/40x40/playlist_bestof.png");
    public static final URL ICON_PLAYLIST_NOVELTIES =  ClassLoader.getSystemResource("org/jajuk/icons/40x40/playlist_novelties.png");
    public static final URL ICON_RUN =  ClassLoader.getSystemResource("org/jajuk/icons/16x16/player_play.png");
    public static final URL ICON_ADD =  ClassLoader.getSystemResource("org/jajuk/icons/16x16/add.png");
    public static final URL ICON_REMOVE =  ClassLoader.getSystemResource("org/jajuk/icons/16x16/remove.png");
    public static final URL ICON_UP =  ClassLoader.getSystemResource("org/jajuk/icons/16x16/up.png");
    public static final URL ICON_DOWN =  ClassLoader.getSystemResource("org/jajuk/icons/16x16/down.png");
    public static final URL ICON_ADD_SHUFFLE =  ClassLoader.getSystemResource("org/jajuk/icons/16x16/add_shuffle.png");
    public static final URL ICON_CLEAR =  ClassLoader.getSystemResource("org/jajuk/icons/16x16/clear.png");
    public static final URL ICON_SAVE =  ClassLoader.getSystemResource("org/jajuk/icons/16x16/save.png");
    public static final URL ICON_SAVE_AS =  ClassLoader.getSystemResource("org/jajuk/icons/16x16/saveas.png");
    public static final URL ICON_DEFAULT_COVER =  ClassLoader.getSystemResource("org/jajuk/icons/16x16/ok.png");
    public static final URL ICON_MODE_NORMAL =  ClassLoader.getSystemResource("org/jajuk/icons/16x16/norm.png");
    public static final URL ICON_NET_SEARCH =  ClassLoader.getSystemResource("org/jajuk/icons/16x16/netsearch.png");
    public static final URL ICON_TRACK_FIFO_PLANNED =  ClassLoader.getSystemResource("org/jajuk/icons/16x16/clock.png");
    public static final URL ICON_TRACK_FIFO_NORM =  ClassLoader.getSystemResource("org/jajuk/icons/16x16/player_perspective.png");
    public static final URL ICON_TRACK_FIFO_REPEAT =  ClassLoader.getSystemResource("org/jajuk/icons/16x16/repeat.png");
    public static final URL ICON_WIZARD = ClassLoader.getSystemResource("org/jajuk/icons/16x16/wizard.png");
    public static final URL ICON_TYPE_MP3 = ClassLoader.getSystemResource("org/jajuk/icons/16x16/type_mp3.png");
    public static final URL ICON_TYPE_OGG = ClassLoader.getSystemResource("org/jajuk/icons/16x16/type_ogg.png");
    public static final URL ICON_TYPE_AU = ClassLoader.getSystemResource("org/jajuk/icons/16x16/type_wav.png");
    public static final URL ICON_TYPE_AIFF = ClassLoader.getSystemResource("org/jajuk/icons/16x16/type_wav.png");
    public static final URL ICON_TYPE_FLAC = ClassLoader.getSystemResource("org/jajuk/icons/16x16/type_flac.png");
    public static final URL ICON_TYPE_WAV = ClassLoader.getSystemResource("org/jajuk/icons/16x16/type_wav.png");
    public static final URL ICON_NO_EDIT = ClassLoader.getSystemResource("org/jajuk/icons/16x16/stop.png");
    public static final URL ICON_EDIT = ClassLoader.getSystemResource("org/jajuk/icons/16x16/edit.png");
    public static final URL ICON_UNKNOWN = ClassLoader.getSystemResource("org/jajuk/icons/16x16/presence_unknown.png");
    public static final URL ICON_TIP = ClassLoader.getSystemResource("org/jajuk/icons/40x40/tip.png");
    public static final URL ICON_TIP_SMALL = ClassLoader.getSystemResource("org/jajuk/icons/16x16/tip.png");
    public static final URL ICON_OPEN_DIR = ClassLoader.getSystemResource("org/jajuk/icons/40x40/folder_open.png");
    public static final URL ICON_STAR_1 = ClassLoader.getSystemResource("org/jajuk/icons/16x16/star1.png");
    public static final URL ICON_STAR_2 = ClassLoader.getSystemResource("org/jajuk/icons/16x16/star2.png");
    public static final URL ICON_STAR_3 = ClassLoader.getSystemResource("org/jajuk/icons/16x16/star3.png");
    public static final URL ICON_STAR_4 = ClassLoader.getSystemResource("org/jajuk/icons/16x16/star4.png");
    public static final URL ICON_DROP_DOWN = ClassLoader.getSystemResource("org/jajuk/icons/16x16/dropdown.gif");
    public static final URL ICON_DIGITAL_DJ = ClassLoader.getSystemResource("org/jajuk/icons/16x16/ddj.png");
    public static final URL ICON_LIST = ClassLoader.getSystemResource("org/jajuk/icons/16x16/contents.png");
    public static final URL ICON_PLAY2 = ClassLoader.getSystemResource("org/jajuk/icons/16x16/play.png");
    ...
    public static final URL IMAGE_SEARCH = ClassLoader.getSystemResource("org/jajuk/images/included/search.png");
