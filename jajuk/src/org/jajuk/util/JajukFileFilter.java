...
public class JajukFileFilter extends FileFilter implements java.io.FileFilter,ITechnicalStrings{
    ...
    public static class AudioFilter implements java.io.FileFilter{
        ...
        public boolean accept(File f) {
            ...
            if (TypeManager.getInstance().isExtensionSupported(Util.getExtension(f))){
                ...
                return (Boolean)TypeManager.getInstance().getTypeByExtension(Util.getExtension(f)).getValue(XML_TYPE_IS_MUSIC);
            }
            return false;
        }
    ...
    /**
     * Filter constructor
     * @param filters undefined list of jajuk filter to be applied (logical AND applied between filters)
     * <p>Example: only audio files new JajukFilter(JajukFileFilter.AudioFilter.getInstance());
     * </p>
     */
     ...
     * Filter constructor
     * @param filters undefined list of jajuk filter to be applied (logical AND applied between filters)
     * @param bAND: should be applied an AND or an OR between filters ?
     * <p>Example: audio files or directories: new JajukFilter(false,JajukFileFilter.DirectoryFilter.getInstance(),JajukFileFilter.AudioFilter.getInstance());
     * </p>
     */
