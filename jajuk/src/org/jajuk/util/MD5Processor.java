...
public class MD5Processor {
    ...
    /**
         * MD5 hashcoding, return a hashcode for the given string Follows RFC
         * 1321
         * 
         * @param bIn
         *                input byte array
    ...
    /*
         ...
         * H(X,Y,Z) = X xor Y xor Z 3: I(X,Y,Z) = Y xor (X v not(Z)) Let [abcd k
         * s i] denote the operation a = b + ((a + F(b,c,d) + X[k] + T[i]) <<<
         * s).
         */
    ...
    /**
         * Non-signed addition. ints are signed, use long instead before
         * computing and come back to int after
         */
