...
public class PreferencesJMenu extends JMenu {
  ...
  public PreferencesJMenu(Item item) {
    ...
    List<Item> selection = new ArrayList<>(1);
    selection.add(item);
    initUI(selection);
  }
  ...
  private void initUI(List<? extends Item> selection) {
    ...
    JMenuItem jmiBan = new JMenuItem(ActionManager.getAction(JajukActions.BAN_SELECTION));
    jmiBan.putClientProperty(Const.DETAIL_SELECTION, selection);
    JMenuItem jmiUnBan = new JMenuItem(ActionManager.getAction(JajukActions.UN_BAN_SELECTION));
    jmiUnBan.putClientProperty(Const.DETAIL_SELECTION, selection);
    JMenuItem jmiAdore = new JMenuItem(ActionManager.getAction(JajukActions.PREFERENCE_ADORE));
    ...
    JMenuItem jmiLove = new JMenuItem(ActionManager.getAction(JajukActions.PREFERENCE_LOVE));
    ...
    JMenuItem jmiLike = new JMenuItem(ActionManager.getAction(JajukActions.PREFERENCE_LIKE));
    ...
    JMenuItem jmiUnset = new JMenuItem(ActionManager.getAction(JajukActions.PREFERENCE_UNSET));
    ...
    JMenuItem jmiAverage = new JMenuItem(ActionManager.getAction(JajukActions.PREFERENCE_AVERAGE));
    ...
    JMenuItem jmiPoor = new JMenuItem(ActionManager.getAction(JajukActions.PREFERENCE_POOR));
    ...
    JMenuItem jmiHate = new JMenuItem(ActionManager.getAction(JajukActions.PREFERENCE_HATE));
