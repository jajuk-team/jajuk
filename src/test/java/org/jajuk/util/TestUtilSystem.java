...
public class TestUtilSystem extends JajukTestCase {
    ...
    protected void specificSetUp() throws Exception {
        file1 = File.createTempFile("test", ".jajuk",
                new java.io.File(ConstTest.DEVICES_BASE_PATH));
    ...
    public void testCopyRecursively() throws Exception {
        ...
        assertEquals("this is some test data", FileUtils
                .readFileToString(new File(dir2.getAbsolutePath() + File.separator + "testfile")));
    }
    ...
    public void testCopyToDir() throws Exception {
        ...
        assertEquals("this is some test data", FileUtils.readFileToString(
                new File(dir.getAbsolutePath() + File.separator + file1.getName())));
    }
    ...
    public void testGetOnlyFile() {
        ...
        assertEquals("images_q=tbn_ANd9GcR3oc63qGvD-UNIESfnOD3ABwJ9JeFdhzE6eEZZFTzw-PBNyOZWdw",
                UtilSystem.getOnlyFile(
                        "images?q=tbn:ANd9GcR3oc63qGvD-UNIESfnOD3ABwJ9JeFdhzE6eEZZFTzw-PBNyOZWdw"));
    }
     ...
     * Test method for.
     *
     * @throws Exception the exception {@link org.jajuk.util.UtilSystem#readFile(java.lang.String)}.
     */
    @Test
    ...
    public void testReadFileError() {
        try {
            ...
            assertEquals(9, e.getCode());
            assertTrue(e.getMessage().contains("notexistingfile"), e.getMessage()); // do
            // we
            // also
            // have
            // the
    ...
    public void testCombineRanges() {
        ...
        // use a consumer which appends all consumed ranges to a string so we can verify the
        // resulting ranges fully
        Consumer<Pair<Integer, Integer>> consumer = pair -> str.append(pair.getLeft()).append("-")
        ...
        UtilSystem.combineRanges(new int[] { 1, 2, 3, 4, 5, 6, 7, 8, 10, 11, 12, 13, 14, 15 },
                consumer);
